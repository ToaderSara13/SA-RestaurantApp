 ...
 * @author Sara
 */
public class UtilizatorPanel extends JPanel{
    private SARestaurantApp sara ;
     
    public UtilizatorPanel(SARestaurantApp sara){
        this.sara = sara;
        initComponents();
    }
    ...
    private void initComponents(){
        ...
        parolaVizibila.setBounds(820, 165, 25, 25);
        ...
        schimbaDate.setBounds(900, 500, 250, 50);
        ...
        saveChanges.setBounds(1050, 570, 100, 50);
        ...
        cancelChanges.setBounds(900, 570, 100, 50);
    ...
    private MouseAdapter changePersonalDataAction(){
        return new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                parolaConfirmataLabel.setBounds(400, 250, 200, 50);
                ...
                parolaConfirmataText.setBounds(580, 250, 230, 50);
                ...
                parolaConfirmataVizibila.setBounds(820, 265, 25, 25);
                ...
                rolLabel.setBounds(400, 350, 200, 50);
                rolText.setBounds(580, 350, 230, 50);
